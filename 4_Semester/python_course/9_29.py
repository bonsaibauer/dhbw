...
class ErrorMsg(QMessageBox):
    ...
    def showEvent(self, event):
        ...
        self.move(int(self.master.geometry().right()-self.frameGeometry().width()), int(self.master.geometry().bottom()-self.frameGeometry().height()))
